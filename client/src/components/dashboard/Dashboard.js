    ...
    if(courses != null){
      ...
      if (user.role === 'admin') {
        dashboardContent = (
          ...
          <Link to="/create-university" className="btn btn-lg btn-info mr-2">Create University</Link>
          <Link to="/create-college" className="btn btn-lg btn-info mr-2">Create College</Link>
          <Link to="/create-course" className="btn btn-lg btn-info">Create Course</Link>
          <hr />
          ...
          <div className="card">
            ...
            <div className="card-body">
                <table className="table table-striped">
                    <thead className="thead-dark"><th>University Name</th> <th>Email</th> <th>Contact No.</th></thead>
                     {university}
                  </table>
            </div>
          </div>
